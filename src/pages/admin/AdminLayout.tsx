...
import { Loader2, Home, LogOut, Calendar, Zap, Database, Settings, Activity, FileText, TrendingUp } from 'lucide-react';
...
const AdminLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/admin/pipeline', label: 'Pipeline', icon: TrendingUp },
