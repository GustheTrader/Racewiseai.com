    ...
    <div className="space-y-6">
      <form onSubmit={handleScrapePreview} className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              {raceTrack && raceNumber && (
                <Button 
                  ...
                  className="shrink-0 border-betting-tertiaryPurple hover:bg-betting-tertiaryPurple/20"
        ...
        <Button 
          ...
          className="w-full bg-betting-tertiaryPurple hover:bg-betting-tertiaryPurple/80"
        >
          {isImporting ? (
            <>
      ...
      {previewData && (
        <Card className="bg-betting-darkPurple border-4 border-betting-tertiaryPurple">
          <CardContent className="pt-4">
            ...
            <div className="bg-betting-dark p-4 rounded-md overflow-auto max-h-80 mb-4 border border-betting-tertiaryPurple">
